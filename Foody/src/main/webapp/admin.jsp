	...
	<section id="cart-view">
		<div class="container">
	        ...
	        <fmt:setBundle basename="i18n.lang" var="lang" />
			    <h3>
					 <a href="#" class="aa-cart-view-btn" data-toggle="modal" data-target="#add-modal">ADMIN PAGE</a>
				</h3>
				<h3>
										...
										<tbody>
											<c:forEach items="${ListProduct}" var="product">
												<tr>
													...
													<td><a class="remove" href="deleteAdmin?pid=${product.id}">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					...
					<form action="addadmin" class="aa-login-form" method="post">

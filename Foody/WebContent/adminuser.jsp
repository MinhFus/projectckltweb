	...
	<section id="cart-view">
		<div class="container">
			<div class="cart-view-total">
				<h3>
					 <a href="#" class="aa-cart-view-btn" data-toggle="modal" data-target="#add-modal">Thêm người dùng</a>
				</h3>
			</div>
			<div class="row">
				<div class="col-md-12">
										...
										<tbody>
											<c:forEach items="${ListUser}" var="user">
												<tr>
													...
													<td><a class="aa-cart-title" href="">${user.username}</a></td>
													<td>${user.password}</td>
													<td>${user.sellIs}</td>
													<td>${user.admin}</td>
													<td><a href="loadUser?uid=${user.id}" class="aa-add-to-cart-btn">Edit</a></td>
													<td><a class="remove" href="delete?uid=${user.id}">

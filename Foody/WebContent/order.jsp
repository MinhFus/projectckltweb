...
<html lang="en">
  <head>
    ...
    <title>Daily Shop | Order Tracking Page</title>
                  ...
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                      	...
                      	<td><c:out value="${order.totalAll}"></c:out></td>
                      	<td><c:out value="${order.detailOrder}"></c:out></td>
                      	<td><c:out value="${order.fullName}"></c:out></td>
                      	<td><c:out value="${order.address}"></c:out></td>
                      	<td><c:out value="${order.phone}"></c:out></td>
                      	<td><c:out value="${order.note}"></c:out></td>        	
                      </tr>                   
                      </tbody>
                  </table>
                </div>
